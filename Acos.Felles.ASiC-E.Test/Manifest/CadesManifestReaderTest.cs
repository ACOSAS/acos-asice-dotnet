    ...
    <DataObjectReference URI=""bii-message.xml"" MimeType=""application/xml"">
        ...
        <ns2:DigestValue>U+i/R1Sa/OqRASwozga2MCGDR8wd/7ZUGztmsm2kl50=</ns2:DigestValue>
            ...
            using (var inputStream = new MemoryStream(Encoding.UTF8.GetBytes(manifest)))
            {
                ...
                AssertionExtensions.Should((int) cadesManifest.Digests.Count).Be(2);
                AssertionExtensions.Should((object) cadesManifest.SignatureFileRef).NotBeNull();
            }
        }
    ...
    <DataObjectReference URI=""bii-message.xml"" MimeType=""application/xml"">
        ...
        <ns2:DigestValue>U+i/R1Sa/OqRASwozga2MCGDR8wd/7ZUGztmsm2kl50=</ns2:DigestValue>
            ...
            using (var inputStream = new MemoryStream(Encoding.UTF8.GetBytes(manifest)))
            {
                ...
                AssertionExtensions.Should((string) action.Should().Throw<ManifestReadException>().And.Message)
